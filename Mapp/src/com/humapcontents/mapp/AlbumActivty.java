...
public class AlbumActivty extends MappBaseActivity implements OnClickListener {
					...
					try 
					{
						...
						if(json.optString("error").equals("0"))
						{
							...
							for(int i = 0; i < usageList.length(); i++)
							{
								...
								item.name =  (list.optString("artist"));
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			if(mBar != null) 
			{
				...
				detailBar1.setOnClickListener(new View.OnClickListener() 
				{
					...
					{
						_AppManager.m_AlbumIndex = mBar.idx;

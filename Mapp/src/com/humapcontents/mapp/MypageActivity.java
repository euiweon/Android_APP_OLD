...
public class MypageActivity extends MappBaseActivity implements OnClickListener {

	private MypageActivity self;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mypage_you_layout);  // 인트로 레이아웃 출력     
    ...
    {
    	{
			...
			Thread thread = new Thread(new Runnable()
			{
				...
				public void run() 
				{
					...
					data.put("id", _AppManager.m_MyPageID);
	...
	public void onClick(View arg0) {
		...
		{
			_AppManager.m_ReciverID = _AppManager.m_LoginID;
			Intent intent;
            intent = new Intent().setClass(self, WinkActivity.class);

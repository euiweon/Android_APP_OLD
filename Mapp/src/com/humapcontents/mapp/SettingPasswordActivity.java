...
public class SettingPasswordActivity extends MappBaseActivity implements OnClickListener {

	private SettingPasswordActivity self;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.setting_password_change_layout);  // 인트로 레이아웃 출력     
	...
	public void ChangePassword()
	{
		...
		Thread thread = new Thread(new Runnable()
		{
			...
			public void run() 
			{
				...
				EditText pass2 = (EditText)findViewById(R.id.newpass_data2);
				EditText pass = (EditText)findViewById(R.id.newpass_data);
				
				
				
				
				if ( oldpass.getText().toString().equals(_AppManager.m_Password) )
				{
				...
				if ( pass.getText().toString().equals(pass.getText().toString()) )
				{
				...
				try {
					...
					entity.addPart("password", new StringBody(getMD5Hash(_AppManager.m_MappToken + pass.getText().toString())));

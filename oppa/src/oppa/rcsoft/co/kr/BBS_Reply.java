...
// 커뮤니티 리플 달기
public class BBS_Reply extends  BaseActivity implements OnClickListener
{
	static public BBS_Reply self;
    ...
    public void RefreshUI()
    {
        ...
        setContentView(R.layout.bbs_detail_epilogue_reply);
    	...
    	if  ( myApp.m_BBSReplyContent.bo_table == "qna" )
    	{
    	...
    	final MyInfo myApp = (MyInfo) getApplication();
    	{
			...
			Thread thread = new Thread(new Runnable()
			{
				public void run() 
				{
					...
					data.put("bo_table", myApp.m_BBSReplyContent.bo_table);
					data.put("w","c");

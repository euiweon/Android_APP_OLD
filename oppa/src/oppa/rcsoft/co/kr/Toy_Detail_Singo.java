...
import oppa.rcsoft.co.kr.Shop_Detail_Singo.MoreBTNClick;
...
// 게시물 신고
public class Toy_Detail_Singo  extends BaseActivity implements OnClickListener
{
	static public Toy_Detail_Singo self;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        self = this;
        setContentView(R.layout.toy_detail_report);
		...
		
		{
	        ...
	        Button MainBtn2 = (Button)findViewById(R.id.shop_main_tab_btn_21);
    ...
    public  class MoreBTNClick implements OnClickListener
    {
		...
		public void onClick(View v )
        {
        	...
        	case R.id.shop_main_tab_btn_21:
        	{
        		Intent intent;

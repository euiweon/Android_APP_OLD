...
public class DonateActivity extends HolyTubeBaseActivity implements OnClickListener  {
    ...
    public void onCreate(Bundle savedInstanceState) {
...

        {
       	...
       	(findViewById(R.id.pay_pal)).setOnClickListener(this);
    ...
    public void onClick(View v )
    {
    	...
    	case R.id.pay_pal:
    	{
    		Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6KS7LGJAWXNH6"));
    		startActivity(intent);
    	}
    		break;

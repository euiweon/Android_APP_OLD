...
public class CookieHTTP 
{
	...
	public void SetCookie(   Map<String, String> data , String Domain,  String path  )
	{
		CookieStore cookieStore = ((DefaultHttpClient)client).getCookieStore();
		List<Cookie> cookieList = cookieStore.getCookies();

		if ( cookieList.size() == 0  && !data.isEmpty() )
		{
	...
	public String GetHTTPSData( String address , Map<String, String> data)
	{
		String returnstring = "error";
		HttpGet httpget = makeHttpGet(address , data);
